      ...
      <main className="flex-grow pb-40 px-6">
        <section className="bg-white pt-48 pb-20 text-center space-y-4">
           <div className="max-w-[1240px] mx-auto space-y-4">
              ...
              <h1 className="text-4xl md:text-5xl font-serif font-black  text-[#1A1A1A] tracking-tight scale-y-105">Article Publishing Charges</h1>
              <p className="text-sm font-bold text-[#6B7280]  max-w-xl mx-auto opacity-70 mt-6 leading-relaxed">EISR is committed to fully open-access publishing models with transparent fee structures.</p>
           </div>
        </section>
                    ...
                    {apcs.map((item, idx) => (
                       <tr key={idx} className="group hover:bg-[#F8FAFC] transition-colors">
                          <td className="p-8 lg:p-12">
                             <div className="text-sm font-black text-[#1A1A1A]  group-hover:text-[#4BA6B9] transition-all uppercase tracking-tight scale-y-105">{item.name}</div>
                          </td>
